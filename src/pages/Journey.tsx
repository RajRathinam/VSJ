...
import { Music, Users, Heart, Award, ArrowLeft, Calendar, Star, Trophy } from 'lucide-react';
 ...
 <Layout>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div data-aos="fade-up" className="bg-card rounded-3xl p-6 md:p-12 shadow-elegant border border-border">
            <h3 className="font-serif text-3xl font-bold text-foreground mb-6">About Me</h3>
            <div className="space-y-4 text-foreground/80 text-justify leading-relaxed">
              <p>
                I am G. Sri Jagan, a passionate violinist and nadaswaram artist currently pursuing my B.E. in Computer Science Engineering. 
              ...
              <p>
                ...
                over 10,000 live performances. Each concert, whether it's an intimate family gathering or a grand wedding celebration, 
                has been an opportunity to touch hearts and create lasting memories through music.
              </p>
              <p>
                The recognition I've received—18 Golden Awards and the prestigious title "Nadha Kala Nithi"—is not just a personal achievement 
                but a testament to the support of my family, my gurus, and the countless audiences who have appreciated my art. My father, 
                Nadaswaram S. Govindan, and my mother, G. Sudha, have been my pillars of strength, guiding me through every step of this journey.
              </p>
              <p>
